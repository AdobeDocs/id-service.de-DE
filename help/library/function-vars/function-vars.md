---
description: Konfigurieren Sie den Besucher-ID-Dienst, indem Sie diese Eigenschaften an die statische Visitor.getInstance-Methode übergeben.
keywords: IMS-Organisations-ID; Besucher-ID-Service
...
Konfigurieren Sie den Besucher-ID-Dienst, indem Sie diese Eigenschaften an die statische Visitor.getInstance-Methode übergeben.
