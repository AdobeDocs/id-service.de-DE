---
description: Mit den Funktionen idSyncByURL und idSyncByDataSource des Besucher-ID-Diensts können Sie eine ID-Synchronisierung im Destination Publishing iFrame manuell implementieren. Diese sind in VisitorAPI.js Version 1.10 oder höher verfügbar.
...
Mit den Funktionen idSyncByURL und idSyncByDataSource des Besucher-ID-Diensts können Sie eine ID-Synchronisierung im Destination Publishing iFrame manuell implementieren. Diese sind in `VisitorAPI.js` Version 1.10 oder höher verfügbar.
