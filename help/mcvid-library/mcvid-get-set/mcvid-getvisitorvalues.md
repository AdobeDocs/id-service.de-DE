...
<ul class="simplelist"> 
 ...
 <li> <a href="../../mcvid-library/mcvid-get-set/mcvid-getvisitorvalues.md#section-36a31683558742a5915db3a391e09f7b" format="dita" scope="local"> Nutzungsszenario 1: Standarddatensatz anfordern </a> </li> 
 <li> <a href="../../mcvid-library/mcvid-get-set/mcvid-getvisitorvalues.md#section-467b2f4e513344c89b7332b05f6f59f3" format="dita" scope="local"> Nutzungsszenario 2: Benutzerdefinierten Datensatz anfordern </a> </li> 
 <li> <a href="../../mcvid-library/mcvid-get-set/mcvid-getvisitorvalues.md#section-4c4c300167694c6fbff1d6c612f372b5" format="dita" scope="local"> Definierte Antwortparameter </a> </li> 
</ul>
...
* *(Optional)* ` visitor.FIELDS. *`Der ID-Typ`*` ist ein Enum, mit dem Sie angeben können, welche [ID-Werte](../../mcvid-library/mcvid-get-set/mcvid-getvisitorvalues.md#section-4c4c300167694c6fbff1d6c612f372b5) diese Funktion zurückgeben soll.
...
<table id="table_32D0FEEA76CE4F298EED4B8F5C644232"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Die Experience Cloud ID des Besuchers. </p> <p>Siehe <a href="../../mcvid-introduction/mcvid-cookies.md" format="dita" scope="local">Cookies und der Experience Cloud ID-Dienst </a>. </p> </td> 
  </tr> 
  <tr> 
