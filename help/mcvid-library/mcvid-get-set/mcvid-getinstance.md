...
>[!CAUTION]
>
>*Wichtig: * Instanziieren Sie die Visitor-Funktion nicht mit `var visitor = new Visitor`. Sie müssen den richtigen, hier aufgeführten Funktionsaufruf verwenden. Gilt für die [!DNL VisitorAPI.js] Code-Bibliothek Version 3.0 oder höher.
...
Wenn von `getInstance` keine bestehende Instanz gefunden wird, wird eine neue Instanz erstellt und zurückgegeben. Dies ist vergleichbar mit der [ `s_gi()` Funktion ](https://marketing.adobe.com/resources/help/de_DE/sc/implement/?f=function_s_gi.html) in [!DNL AppMeasurement].
