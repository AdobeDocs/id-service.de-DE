...
Diese Änderungen werden auch in den [Experience Cloud Release Notes](https://marketing.adobe.com/resources/help/de_DE/whatsnew/) erfasst. Siehe die [älteren Versionshinweise](https://marketing.adobe.com/resources/help/de_DE/whatsnew/?f=c_legacy_releases.html) für ältere [!DNL Experience Cloud] Ankündigungen.
...
>* Ab Experience Cloud ID-Dienst-Bibliothek 2.0.0 beginnt die ID-Synchronisierung für Adobe Media Optimizer standardmäßig. Siehe [ID-Synchronisierung und Trefferraten verstehen ](https://marketing.adobe.com/resources/help/de_DE/mcvid/mcvid-match-rates.html).
>
...
* Es wurde `Visitor.getLocationHint,` eine neue Funktion hinzugefügt, die eine Region-ID zurückgibt. Siehe [Get Region IDs (Standorthinweis)](../mcvid-library/mcvid-get-set/mcvid-getlocationhint.md#reference-a761030ff06c4439946bb56febf42d4c).

* `idSyncByURL` und `idSyncByDataSource` wurden hinzugefügt, 2 Funktionen, mit der Sie manuell eine ID-Synchronisation im Destination Publishing iFrame implementieren können. Siehe [ID-Synchronisierung über URL oder Datenquelle](../mcvid-library/mcvid-get-set/mcvid-idsync.md#reference-b01b88c083434cf8abbeabd3c6956c48).
...
**Neu:** [Abrufen von Regionen- und Benutzer-IDs aus dem AMCV-Cookie](../mcvid-reference/mcvid-regions.md#concept-15b2c8c894b846a48f1f61a353cfdf4e)
...
Überarbeitet: [Anforderungen an den Experience Cloud ID-Dienst](../mcvid-reference/mcvid-requirements.md)
...
* Das standardmäßige `loadTimeout`-Intervall wurde (von 500 Millisekunden) auf 30.000 Millisekunden festgelegt. Siehe [Visitor.getInstance-Funktionsvariable](../mcvid-library/mcvid-function-vars/mcvid-function-vars.md).
