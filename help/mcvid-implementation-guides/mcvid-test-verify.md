...
Ihre Dienstintegration ist richtig konfiguriert, wenn in der [!DNL Adobe]-Debugger-Antwort eine [!DNL Experience Cloud ID] (MID) angezeigt wird. Siehe [Cookies und der Experience Cloud ID-Dienst](../mcvid-introduction/mcvid-cookies.md) mit weiteren Informationen zur MID.
